    ...
    <>
      ...
      <div>
        ...
        <Input
          className="w-full"
          {...bacteriaAmoutField}
          inputref={bacteriaAmoutField.ref}
          type="text"
        />
      </div>
      <div>
        ...
        <Input
          className="w-full"
          {...addedOilAmountField}
          inputref={addedOilAmountField.ref}
          type="text"
        />
      </div>
      <div>
      ...
      <div>
        ...
        <Input
          className="w-full"
          {...serviceAdditivesField}
          inputref={serviceAdditivesField.ref}
          type="text"
        />
      </div>
      <div>
      ...
      <div>
        ...
        <Input
          className="w-full"
          {...reasonField}
          inputref={reasonField.ref}
          type="text"
        />
      </div>
      <Button
        className="disabled:pointer-events-none"
        onClick={handleSubmit(onIndicatorsEdit)}
        disabled={!isValid}
      >
        Подтвердить
      </Button>
